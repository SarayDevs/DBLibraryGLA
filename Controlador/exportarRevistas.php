<?php
require '../Modelo/Datosrevista.php';  // Ajusta la ruta según tu estructura
...
try {
    $revistaModelo = new misRevistas();  // Instancia de la clase donde está la función
    $revistas = $revistaModelo->verTodasLasRevistas();  // Obtener las revistas
    ...
    // Encabezados
    $encabezados = array_keys($revistas[0]);  // Obtener los nombres de las columnas
...
$sheet->getStyle('A1:' . $sheet->getHighestColumn() . '1')->applyFromArray($styleArray);
    ...
    $sheet->fromArray($revistas, NULL, 'A2');

    // Crear el archivo Excel
    $writer = new Xlsx($spreadsheet);
    $nombreArchivo = "revistas_" . date("Ymd_His") . ".xlsx";
